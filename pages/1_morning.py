...
st.title("🏛️ J.F2.A 앤트리치 시황 브리핑 공장 V4.1 (Pro Edition)")
...
if st.button(btn_text, use_container_width=True):
    with st.spinner(f"데이터와 뉴스를 싹쓸이하여 {target_market} 전문 전략 보고서를 작성 중입니다... ☕ (캐싱 적용으로 약 10초 소요)"):
        ...
        3. [줄바꿈 강제]: 가독성을 위해 본문을 작성할 때 문장이 마침표(.)로 끝나면, 무조건 줄바꿈(엔터)을 하여 다음 내용이 새로운 줄에서 시작되도록 하세요. 
        ...
        5. [🎨 이미지 AI용 주문서]: 정확히 아래 문장만 그대로 출력해 주세요.
